...
**Andrey Berestov**  
Email: andrey.berestov@gmail.com  
...
- Baxandall-like Bass / Treble  
- Soft volume  
- Automatic Pre-EQ Headroom with temporary manual trim  
- Clip detection with visual indicator  
...
In this state, the internal DSP stage is **not applied to the signal path**.
...
ETH (ERC-20): 0x37385DA1388F2921583d4750FB44Def7D76cAb23
